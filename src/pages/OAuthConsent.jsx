...
// Local-only app flow: this consent screen is kept as a harmless placeholder for
// compatibility, but the frontend does not depend on any external auth backend.
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Gate on the server's auth result, not on any external SDK session:
